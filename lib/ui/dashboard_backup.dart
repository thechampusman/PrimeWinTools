            ...
            child: Container(
              ...
              child: Row(
                children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              // Enhanced glassmorphic app icon
                              Container(
                                width: 56,
                                height: 56,
                                decoration: BoxDecoration(
                  ...
                  // 🎨 Right Content Area (80%) - White background
                  Expanded(
                    child: Container(
                      color: Colors.white,
          ...
          decoration: BoxDecoration(
            gradient: widget.selected
                ...
                : _hovering
                    ? const LinearGradient(
                        colors: [
                          Colors.transparent, // Fully transparent on hover
                          Colors.transparent,
                        ],
                      )
                    : const LinearGradient(
                        colors: [
                          Colors.transparent, // Fully transparent default
                          Colors.transparent,
                        ],
                      ),
            borderRadius: BorderRadius.circular(16),
            border: Border.all(
              color: widget.selected
                  ? Colors.white
                      .withOpacity(0.48) // Keep selected border visible
                  : Colors.transparent, // Transparent borders for non-selected
              ...
              Container(
                ...
                decoration: BoxDecoration(
                      ...
                      ? LinearGradient(
                          colors: [
                            Colors.white.withOpacity(
                                0.24), // Keep selected icon visible
                  ...
                  border: Border.all(
                    color: widget.selected
                        ? Colors.white
                            .withOpacity(0.24) // Keep selected border visible
                        : Colors.transparent, // Transparent for non-selected
                    width: 1,
                  ),
                  boxShadow: [
                ...
                child: Icon(
                  widget.icon,
                  color:
                      widget.selected ? Colors.white : const Color(0xFF374151),
                  size: 18,
                ),
              ),
              const SizedBox(width: 14),
              // Enhanced label with glassmorphic background
              Expanded(
                child: Container(
                  padding:
                  ...
                  decoration: BoxDecoration(
                    color: widget.selected
                        ? Colors.white
                            .withOpacity(0.12) // Keep selected label background
                        : Colors.transparent, // Transparent for non-selected
                    borderRadius: BorderRadius.circular(8),
                    border: widget.selected
                        ? Border.all(
                            color: Colors.white
                                .withOpacity(0.16), // Keep selected border
                            width: 0.5,
                          )
                        : null,
                  ),
