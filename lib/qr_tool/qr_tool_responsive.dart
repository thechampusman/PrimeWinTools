...
class _QRCodeToolState extends State<QRCodeTool> {
  ...
  bool _usePythonImplementation = false;
  ...
  String _getQRToolPath() {
    ...
    return path.join(appDir, 'lib', 'qr_tool', 'qr_tool.html');
  }
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                Expanded(
                                  child: RadioListTile<bool>(
                                    title: const Text('Web-based'),
                                    subtitle:
                                        const Text('Uses browser (current)'),
                                    value: false,
                                    groupValue: _usePythonImplementation,
                                    onChanged: (value) {
                                      setState(() {
                                        _usePythonImplementation = false;
                                      });
                                    },
                                  ),
                                ),
                                Expanded(
                                  child: RadioListTile<bool>(
                                    title: Text(_pythonAvailable
                                        ? 'Python-based'
                                        : 'Python-based (N/A)'),
                                    subtitle: Text(_pythonAvailable
                                        ? 'Native QR generation'
                                        : 'Python not found'),
                                    value: true,
                                    groupValue: _usePythonImplementation,
                                    onChanged: _pythonAvailable
                                        ? (value) {
                                            setState(() {
                                              _usePythonImplementation = true;
                                            });
                                          }
                                        : null,
                                  ),
                            ...
                            if (_usePythonImplementation && _pythonAvailable)
                              Align(
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: const Text('Open Python QR Tool'),
                                ),
                              ),
                          ],
                        ),
